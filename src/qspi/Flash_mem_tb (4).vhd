...
data_input_sig    <= X"00000000", X"00000070" after 50 us,
					X"00000001" after 52 us,X"00000000"  after 53.1 us; --:IN  std_logic_vector(31 downto 0);


address_sig       <= X"00", X"0C" after 50 us,
					 X"10" after 52 us;--:IN  std_logic_vector(7  downto 0);


write_en_sig      <= '0', '1' after 51 us, '0' after 52 us,
					  '1' after 53 us, '0' after 53.1 us, '1' after 53.2 us, '0' after 54 us;-- :IN  std_logic;  


read_en_sig       <= '0', '1' after 60 us, '0' after 61 us;--:IN  std_logic  
